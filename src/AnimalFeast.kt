...
fun feast (animalName: String, dish: String): Boolean{
    val animalFirstLetter = animalName.first()
    val animalLastLetter = animalName.last()

    println()
    return dish.first() == animalFirstLetter && dish.last() == animalLastLetter
}